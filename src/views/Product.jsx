...
class Product extends React.PureComponent {
  ...
  getFlowerList() {
<<<<<<< HEAD
    axios.post(" /home/GetProductListPrice").then(response => {
      let result = response.data;
      console.log(result);
      //  this.state.getFlowers =result
      //  let getFlowers= this.state.getFlowers
      // if (result.Status === 0 && result.DataStatus===200) {
      this.setState({
        getFlowers: result
      });
